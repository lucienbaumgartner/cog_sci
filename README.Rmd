...
## Data Distribution
Fig. 1 (next page) shows the distributions of cancellability ratings per item.

![per item](./output/plots/1a_RERUN_boxplot_item.png)

Fig. 2 (next page) shows the same ratings aggregated per item group and polarity.
